...
func main() {
	...
	// 4) Instantiate hpke.Client over gRPC with A2A transport; resolver fetches the KEM public key over HTTP
	...
	cli := hpke.NewClient(transport, resolver, clientSignKP, clientDID, hpke.DefaultInfoBuilder{}, cliMgr)
