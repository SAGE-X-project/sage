...
| internal/vectors | internal | 7 | 1502 | 117 | 48 | 5 | 0 | 1 | 7 | 23 |
...
| pkg/agent/crypto/keys | pkg | 10 | 1496 | 2750 | 85 | 7 | 0 | 16 | 1 | 24 |
...
| pkg/agent/session | pkg | 7 | 1835 | 2604 | 90 | 15 | 3 | 6 | 0 | 15 |
...
graph LR
  ...
  cmd_sage_vectors --> internal_vectors
  ...
  internal_vectors --> pkg_agent_core_rfc9421
  internal_vectors --> pkg_agent_crypto_jcs
  internal_vectors --> pkg_agent_crypto_keys
  internal_vectors --> pkg_agent_did
  internal_vectors --> pkg_agent_hpke
  internal_vectors --> pkg_agent_session
  internal_vectors --> pkg_version
...
| internal/vectors.seed32 | 7 |
| pkg/agent/crypto/chain.GetProvider | 7 |
| internal/vectors.hx | 6 |
| internal/vectors.str | 6 |
...
| internal/vectors.cryptoSuite | 175 | internal/vectors/crypto.go:17 |
| internal/vectors.didSuite | 174 | internal/vectors/did.go:13 |
| internal/vectors.hpkeSuite | 164 | internal/vectors/hpke.go:25 |
| internal/vectors.sessionSuite | 153 | internal/vectors/session.go:28 |
...
| internal/vectors.rfc9421Suite | 107 | internal/vectors/rfc9421.go:165 |
