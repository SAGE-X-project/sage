...
| cmd/sage-crypto | `verify` | cmd/sage-crypto.runVerify | pkg/agent/crypto/formats(12), pkg/agent/crypto/keys(45) |
...
| cmd/sage-did | `validate [FILE]` | cmd/sage-did.runCardValidate | pkg/agent/crypto/chain(2), pkg/agent/crypto/jcs(6), pkg/agent/crypto/keys(4), pkg/agent/did(28), pkg/agent/did/ethereum(2) |
...
- pkg/agent/handshake (36 funcs, 948 LOC)
