...
| examples/mcp-integration/basic-tool | examples | pkg/agent/core(2), pkg/agent/core/message/nonce(4), pkg/agent/core/rfc9421(42), pkg/agent/crypto(5), pkg/agent/crypto/chain(2), pkg/agent/crypto/chain/ethereum(3), pkg/agent/crypto/chain/solana(1), pkg/agent/crypto/keys(3), pkg/agent/did(21), pkg/agent/did/ethereum(4) |
...
| cmd/sage-did | `key` | - |  |
| cmd/sage-did | `list` | cmd/sage-did.runList | pkg/agent/did(13), pkg/agent/did/ethereum(3) |
| cmd/sage-did | `list <did>` | cmd/sage-did.runKeyList | pkg/agent/crypto/keys(3), pkg/agent/did(21), pkg/agent/did/ethereum(2) |
...
| cmd/sage-did | `resolve [DID]` | cmd/sage-did.runResolve | pkg/agent/did(17), pkg/agent/did/ethereum(2) |
