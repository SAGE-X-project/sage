...
class DidTest {
    ...
    void testValidEthereumDid() throws SageException.DidException {
        String didString = "did:sage:ethereum:0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb";
        Did did = new Did(didString);

        assertEquals(didString, did.toString());
        assertEquals("ethereum", did.getNetwork());
        assertEquals("0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb", did.getAddress());
    }
    ...
    void testFromParts() throws SageException.DidException {
        ...
        assertEquals("did:sage:ethereum:0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb", did.toString());
        assertEquals("ethereum", did.getNetwork());
    }
    ...
    @Test
    void testIsValid() {
        assertTrue(Did.isValid("did:sage:ethereum:0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb"));
    ...
    void testEquality() throws SageException.DidException {
        Did did1 = new Did("did:sage:ethereum:0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb");
        Did did2 = new Did("did:sage:ethereum:0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb");
